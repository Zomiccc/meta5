        ...
        {affiliate ? (
          <div className="space-y-6">
            <motion.div
              ...
              className="rounded-bn-lg border border-yellow/30 bg-gradient-to-br from-yellow/10 to-transparent p-6 shadow-glow-yellow"
            >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-1 text-3xl font-bold tnum text-bnText-primary">{affiliate.totalReferred}</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 16 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="mt-1 text-3xl font-bold tnum text-bnText-primary">${Number(affiliate.totalCommission || 0).toFixed(2)}</p>
              </motion.div>
            </div>
